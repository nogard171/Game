...
public class SmeltingMenu {
	...
	public void render() {
		if (showMenu) {
			...
			int cartX = (int) (UserInterface.smelting.baseBounds.getX()
					+ (itemPosition.x - UserInterface.smelting.baseBounds.getX()));
			int cartZ = (int) (UserInterface.smelting.baseBounds.getY()
					+ (itemPosition.y - UserInterface.smelting.baseBounds.getY()));
